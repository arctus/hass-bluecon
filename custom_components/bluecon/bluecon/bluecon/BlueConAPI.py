...
class BlueConAPI:
    ...
    async def registerAppToken(self, active: bool) -> bool:
        if self.deficeId is None:
            ...
            credentials = asyncio.run(self.__notificationInfoStorage.retrieveCredentials())
            if credentials is None:
                ...
                asyncio.run(self.__notificationInfoStorage.storeCredentials(credentials))
